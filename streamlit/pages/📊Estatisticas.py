...
if chart_selection == "Patentes concedidas (16.1)":
    ...
    st_echarts(options=options, height="400px")
        ...
        try:
            ...
            output = f"O pedido {numero} é um recurso que teve o 12.2 em {ano}. O pedido foi indeferido pela {divisao}, que por sua vez em 2024 tem um estoque de {estoque_2024} de recursos de pedidos com 12.2 em {ano} ou anteriores. Em 2024 a produção de primeiros exames de recurso de pedidos indeferidos nesta divisão é de {producao_2024} pareceres nos primeiros 9 meses do ano. O valor anualizado estimado é de {producao_2024_anualizada} primeiros exames. " 
            if (producao_2024_anualizada>estoque_2024):
                outuput = output + " Desta forma, esse estoque de {ano}, mantida a produção atual, terá seu primeiro exame em menos de um ano."
            st.write(output)
